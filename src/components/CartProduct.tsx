        ...
        <div className='flex items-center px-2 gap-4'>
            <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-6'>
                   <div className='flex items-center mt-1 justify-between border border-gray-300 px-4 py-1
                   ...
                   hover:bg-gray-300 cursor-pointer decoration-purple-500'>
                        <LuPlus/>
                    </span>
                    ...
                    className='flex items-center text-sm font-medium text-gray-400 hover:text-red-700
                        cursor-pointer duration-300'>
                            <IoMdClose className='mt-[2px]'/> <p>Remover</p>
