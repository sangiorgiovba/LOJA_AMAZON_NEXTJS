        ...
        ({
          ...
          >
                ...
                group-hover:translate-x-0  transition-transform duration-300 '>
                    ...
                    className='w-full h-full border-b-[1px] border-gray-400
                    flex items-center justify-center text-xl bg-transparent
                    hover:bg-amazon_yellow cursor-pointer duration-3000  '
                    >
                      <HiShoppingCart/>
                    </span>
                    <span
                ...
                {isNew &&(
                    <p className='absolute top-0 right-0 text-amazon_blue
                    font-medium text-sm tracking-wide animate-pulse'>
                        Precos <FormattedAmount amount={oldPrice - price}/>
                    </p>
                )}
              </div>
              <hr />
              <div className='px-4 py-3 flex flex-col gap-1'>
                ...
                className='h-10 font-medium bg-amazon_blue text-white
                 rounded-md hover:bg-amazon_yellow hover:text-black duration-300
